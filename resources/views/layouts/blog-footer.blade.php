						...
						<div class="row clearfix">
							...
							<div class="footer-column col-lg-6 col-md-6 col-sm-12">
								<div class="footer-widget logo-widget">
									<div class="logo">
										<a href="{{ route('index') }}"><img src="{{asset('images/footer-logo.png')}}" alt="" /></a>
									</div>
							...
							<div class="footer-column col-lg-6 col-md-6 col-sm-12">
								<div class="footer-widget contact-widget">
									...
									<ul class="contact-list">
										<li><span class="icon fa fa-phone"></span> +234-810 093 2220</li>
										<li><span class="icon fa fa-envelope"></span> Cluster C, Gold Crest Executive,  <br> Jumeirah Lake Towers, Dubai, United Arab Emirates</li>
